          ...
          <div className="w-full max-w-md">
            <div className="mb-10">
              ...
              <p className="mt-4 text-sm leading-6 text-muted-foreground">
                Entra como profesor para preparar la clase o como estudiante para unirte con codigo.
              </p>
            </div>

            <div className="mb-8 grid grid-cols-2 rounded-md bg-muted p-1">
              <button
                className={`rounded px-4 py-2 text-sm font-medium transition ${
                  role === "teacher" ? "bg-white text-foreground shadow-sm" : "text-muted-foreground"
                }`}
              ...
              <button
                className={`rounded px-4 py-2 text-sm font-medium transition ${
                  role === "student" ? "bg-white text-foreground shadow-sm" : "text-muted-foreground"
                }`}
